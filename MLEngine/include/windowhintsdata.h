...
struct MLENGINE_SHARED_EXPORT WindowHintsData{
    ...
    int client_api; //GLFW_OPENGL_API, GLFW_OPENGL_ES_API or GLFW_NO_API
    ...
    int context_creation_api; //GLFW_NATIVE_CONTEXT_API, GLFW_EGL_CONTEXT_API or GLFW_OSMESA_CONTEXT_API
    ...
    int opengl_profile; //GLFW_OPENGL_ANY_PROFILE, GLFW_OPENGL_COMPAT_PROFILE or GLFW_OPENGL_CORE_PROFILE
    ...
    int context_robustness; //GLFW_NO_ROBUSTNESS, GLFW_NO_RESET_NOTIFICATION or GLFW_LOSE_CONTEXT_ON_RESET
    ...
    int context_release_behavior; //GLFW_ANY_RELEASE_BEHAVIOR, GLFW_RELEASE_BEHAVIOR_FLUSH or GLFW_RELEASE_BEHAVIOR_NONE
